...
public class FM20XX extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Team AdM = new Team("Atletico de Manila", "ADM", "Manila", "Rizal Memorial Stadium", 0, 0, 0, 0, 0, 450000000, 60, 40, 10, "s", prem);
        Team DD = new Team("Dynamo Dresden", "DD", "Dresden", "Rudolf-Harbig-Stadion", 0, 0, 0, 0, 0, 550000000, 70, 60, 10, "s", prem);
        Team SS = new Team("Sofia Strikers", "SS", "Sofia", "Vasil Levski National Stadium", 0, 0, 0, 0, 0, 450000000, 60, 40, 10, "s", prem);
        Team YM = new Team("Yokohama Marinos", "YM", "Yokohama", "Nissan Stadium", 0, 0, 0, 0, 0, 550000000, 70, 60, 10, "s", prem);
